  ...
  try {
    ...
    //===================================================== Client ==========================================
      ...
      schema = Joi.object({
        ...
        advtHuePercentage: Joi.string().allow(''),
        ...
        clientApprovalRate: Joi.string().allow(''),
      ...
      schema = Joi.object({
        ...
        advtHuePercentage: Joi.string().optional().allow(''),
        ...
        advtPositionPercentage: Joi.string().optional().allow(''),
        ...
        advtClientPosition: Joi.string().optional().allow(''),
        ...
        clientApprovalRate: Joi.string().optional().allow(''),
    ...
    else if (path == '/addOohTrainAd') {

      schema = Joi.object({
        roDate: Joi.date().default(new Date()),
        clientName: Joi.string().required(),
        brand: Joi.string(),
        campaignPeriod: Joi.string(),
        numberOfMonths: Joi.number().integer().min(1),
        advertisementType: Joi.string(),
        trainName: Joi.string(),
        route: Joi.string(),
        position: Joi.string(),
        numberOfCoachesPerTrain: Joi.number().integer().min(1),
        numberOfTrains: Joi.number().integer().min(1),
        costPerMonthPerBus: Joi.number().min(0),
        totalAmount: Joi.number().min(0),
        discountType: Joi.string().valid('discountPercentage', 'flatDiscountAmount', 'flatMediaRate'),
        nettAmount: Joi.number().min(0),
        gst: Joi.number().min(0),
        totalPayable: Joi.number().min(0),
        printAndMountingCost: Joi.number().min(0),
        discountedAmount: Joi.number().min(0),
        note: Joi.string(),
        attachedFile: Joi.string(),
        clientDiscountType: Joi.string().valid('percentageFromTotalAmount', 'flatDiscount', 'flatRate'),
        value4Client: Joi.number().min(0),
        clientRate: Joi.number().min(0),
        discountedValue4Client: Joi.number().min(0),
        clientBillingRate: Joi.number().min(0),
        gst4Client: Joi.number().min(0),
        remindStatus: Joi.boolean().default(false),
        isRoGenerated: Joi.boolean().default(false),
        roUrl: Joi.string().default(null),
        isClientRoGenerated: Joi.boolean().default(false),
        isVendorRoGenerated: Joi.boolean().default(false),
        clientRoUrl: Joi.string().default(null),
        vendorRoUrl: Joi.string().default(null),
        vendorId: Joi.string(),
        billValue4Client: Joi.number().min(0)

      });
    }
    else if (path == '/updateOohTrainAd') {

...
const releaseOrderRadioFCTSchema = new Schema({
...
module.exports = model('ReleaseOrderOfRadioFCT', releaseOrderRadioFCTSchema, config.dbPrefix + 'TCFOIDARFOREDROESAELER')
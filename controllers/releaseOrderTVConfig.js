...
exports.TVROFCTList = async (req, res) => {
    try {
        ...
        const TVROs = await TvRoFctModel.find(query)
            ...
            //     select: 'advtPos'
            // })
            .select("roNumber media client clientName clientId companyName channel agencyNameForBilling advertiserNameForBilling adDuration totalWithGST remindStatus isRoGenerated attachedFile isClientRoGenerated isVendorRoGenerated clientRoUrl vendorRoUrl vendorId roDate").sort({ "roNumber": -1 });
